<?php /*a:4:{s:64:"E:\SSD\wamp\www\design\application\index\view\user\userinfo.html";i:1582016139;s:64:"E:\SSD\wamp\www\design\application\index\view\common\header.html";i:1581748649;s:61:"E:\SSD\wamp\www\design\application\index\view\common\nav.html";i:1582015059;s:64:"E:\SSD\wamp\www\design\application\index\view\common\footer.html";i:1581239273;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-4">
			<div class="padding bg-white-o margin-vertical text-center radius-lg">
				<p class="text-left border-bottom-black padding lead">基本信息</p>
				<img src="http://localhost/design/public/static/img/avatar.png"  class="img-reponsive img-circle  user-avatar" >

				<p>三文鱼 | 621325</p>
				身高 体重 年龄 性别  运动量
				<dl class="dl-horizontal">
					<p class="line-height border-bottom"><dt> 昵	称 ：</dt>	<dd>三文鱼</dd></p>
					<p class="line-height border-bottom"><dt> 账	号 ：</dt>	<dd>三文鱼</dd></p>
					<p class="line-height border-bottom"><dt> 邮	箱 ：</dt>	<dd>三文鱼</dd></p>
				</dl>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="padding bg-white-o margin-vertical text-center radius-lg">
				<p class="text-left border-bottom-black padding lead">我的目标：减肥/增重</p>
				<p>目标体重</p>
				<p>当前体重</p>
				<p>我的计划</p>
				<p>实际行动</p>
			...
			<div class="bg-white-o padding-min radius-lg margin-vertical col-xs-12">

                <div id="index-goal-chart" style="min-height:300px;"></div>
            </div>
		</div>

		<div class="col-md-4">
			<div class="padding bg-white-o margin-vertical text-center radius-lg">
				<p class="text-left border-bottom-black padding lead">食物白名单</p>
				<p>目标体重</p>
				<p>当前体重</p>
				<p>我的计划</p>
			...
			<div class="padding bg-white-o margin-vertical text-center radius-lg">
				<p class="text-left border-bottom-black padding lead">食物黑名单</p>
				<p>目标体重</p>
				<p>当前体重</p>
				<p>我的计划</p>
...
var goal = echarts.init(document.getElementById('index-goal-chart'));
    var goption = {
        title: {
            text: '目标达成度'
        },
